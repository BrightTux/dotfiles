...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "| terminal ", "| firefox ", "| office ", "| private ", "| file manager ", "| misc 1 ", "| misc 2 ", "| misc 3 |" }, s, awful.layout.layouts[1])
...
awful.rules.rules = {
    ...
    { rule = { class = "firefox" },
      properties = { screen = 1, tag = "| firefox ", maximized = false, floating = false } },
